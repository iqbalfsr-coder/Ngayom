<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <td>
                <form action="<?= base_url('admin/editpack/') . $m['id_order']; ?>" method="post">
                    <input type="text" name="id_order" id="id_order" value="<?= $m['id_order']; ?>" hidden>
                    <input type="text" name="status_order" id="status_order" value="2" hidden>
                    <input type="text" name="resi" id="resi" value="">
